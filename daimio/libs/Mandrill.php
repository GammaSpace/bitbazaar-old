...
class Mandrill {
    ...
    public function readConfigs() {
        ...
        if(!$apikey) {
          $apikey = $GLOBALS['X']['SETTINGS']['mandrill']['api_key'];
          if ($apikey) return $apikey;
        }
    ...
    {
      $sender = new Mandrill_Messages($this);
      return $sender->send($message);
    }
    
    public function send_template($message, $template_name, $template_content)
    {
      $sender = new Mandrill_Messages($this);
      return $sender->sendTemplate($template_name, $template_content, $message);     
    }
}
