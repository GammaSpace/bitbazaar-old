...
/**
 * Contoured portholes for peeking into the data ocean
 *
 * @package daimio
 * @author dann toliver
 * @version 1.0
...
class Lens
{
  ...
  */ 
  ...
  {
    FileLib::create_lenslike_handler(self::$type, self::$table, 'Contoured portholes for peeking into the data ocean');
  }
  ...
  */ 
  static function add($keyword, $keyholes, $params=NULL, $required=NULL, $apropos=NULL, $description=NULL, $tags=NULL)
  {
    ...
    if(file_exists($content_dir))
      if(!file_exists("$content_dir/lens/$keyword/conditions.daml"))
        FileLib::create_file("conditions.daml", "$content_dir/lens/$keyword");     
    ...
    if(file_exists($content_dir))
      if(!file_exists("$content_dir/lens/$keyword/actions.daml"))
        FileLib::create_file("actions.daml", "$content_dir/lens/$keyword");
  ...
  */ 
  static function destroy($keyword)
  {
    ...
    // remove content
    Content::destroy("lens/$keyword/conditions");
    Content::destroy("lens/$keyword/actions");
