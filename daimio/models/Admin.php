...
EOT;
  ...
  *
  * @param string A username
  * @param string The status (accepts pending, active, inactive)
  * @return string
  * @key admin
  */
  static function set_status($for, $to)
  {
    ...
    if(!in_array($to, array('pending', 'active', 'inactive')))
  ...
  */
  static function sendmail($address, $subject, $body)
  {
    ...
    mail($address, $subject, $body, 'From:hello@thebitbazaar.com');
  }
