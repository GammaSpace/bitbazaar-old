...
class Article
{
  ...
  * @key __world
  */
  static function find($by_ids=NULL, $by_name=NULL, $by_date_range=NULL, $by_author=NULL, $by_square=NULL, $by_key=NULL, $by_type=NULL, $options=NULL)
  {
    if(isset($by_ids))
    ...
    // get only blog posts by default
    if(isset($by_type))
      $query['type'] = $by_type;
  ...
  */
  static function set_type($id, $value)
  {
    ...
    MongoLib::set('articles', $id, $update);
    History::add('articles', $id, array('action' => 'set_type', 'value' => $value));
    ...
    if($value == 'bbs') {
      ...
      PermLib::grant_permission(array('articles', $id), "user:*", 'view');
      return $id;
      }
    if($value == 'blog'){
  ...
  */
  static function publish($id)
  {
    ...
    if($article['type'] = "bbs") {
      PermLib::grant_permission(array('articles', $id), "__member:*", 'view');
    }
    else {
      PermLib::grant_permission(array('articles', $id), "world:*", 'view');
    }
